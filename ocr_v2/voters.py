...
#we can install popper path in local system download -->'https://appsonwindows.com/download/8128044/17/'
poppler_path = r'C:\Users\vivif\Desktop\convert\poppler-0.68.0\bin'
pytesseract.pytesseract.tesseract_cmd = r"C:\Program Files\Tesseract-OCR\tesseract.exe"
# we can install pytesseract link download -->"https://ironsoftware.com/csharp/ocr/blog/ocr-tools/tesseract-ocr-windows/"


from pymongo import MongoClient

# output_file = r'D:\projects\pytesseract\images'  ## give images folder path
output_file = r'C:\Users\vivif\Desktop\files'
folder_path = r'C:\Users\vivif\Desktop\New folder'  ## give pdf's folder path
...
mycollection = mydatabase['dummy2']
mycollection2 = mydatabase['dummy']
